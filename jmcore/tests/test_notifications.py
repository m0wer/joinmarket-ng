...
class TestNotificationConfig:
    ...
    def test_default_config(self) -> None:
        ...
        assert config.urls == []
        assert config.title_prefix == "JoinMarket"
...
class TestNotifier:
    ...
    def test_format_nick(self) -> None:
        ...
        # Long nick (truncated)
        assert "..." in notifier._format_nick("verylongnickname")
    ...
    async def test_tor_proxy_configuration(self) -> None:
        ...
        with (
            ...
            assert os.environ.get("HTTP_PROXY") == "socks5://192.168.1.100:9150"
            assert os.environ.get("HTTPS_PROXY") == "socks5://192.168.1.100:9150"
