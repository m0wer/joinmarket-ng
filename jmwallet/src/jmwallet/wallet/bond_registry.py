...
class FidelityBondInfo(BaseModel):
    ...
    cert_pubkey: str | None = None  # Hot wallet certificate public key
    cert_privkey: str | None = None  # Hot wallet certificate private key (encrypted/protected)
    cert_signature: str | None = None  # Signature of certificate by UTXO key
